...
public class realNutsDrop extends LinearOpMode {
    ...
    private void telem(){
      ...
      telemetry.addData("E3 Intake Arm", E3.getPower());
      ...
      telemetry.addData("e3bus",E3.isBusy());
      ...
      telemetry.addData("E3 Position", E3.getCurrentPosition());
    }
    ...
    private void arm(){
      ...
      if ((gamepad2.a || gamepad2.b || gamepad2.x || gamepad2.y)){
        ...
        if (E3.getTargetPosition() > E3.getCurrentPosition()){
            E3.setPower(0.5);
        } else if(E3.getTargetPosition() < E3.getCurrentPosition()){
            E3.setPower(-0.5);
        }else{
            E3.setPower(0);
        }
    ...
    public void runOpMode() throws InterruptedException {
        ...
        E3.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
